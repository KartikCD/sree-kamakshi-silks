    ...
    <section id="reviews" className="py-16 bg-[#e573731a]">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-bold text-6xl text-[#483d8b] mb-4 font-sans">
            What Our Customers Say
          </h2>
          <p className="text-xl text-[#333333] font-sans">
                ...
                <Card className="h-[280px] bg-white shadow-[0px_4px_6px_#0000001a,0px_2px_4px_#0000001a] rounded-lg">
                  <CardContent className="p-6">
                    <div className="flex items-center mb-6">
                      ...
                      <div className="ml-4">
                        <h3 className="font-bold text-xl text-[#483d8b] font-sans">
                          {testimonial.name}
                        </h3>
                      </div>
                    </div>
