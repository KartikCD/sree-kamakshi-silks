      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="font-bold text-white text-2xl leading-6">
              Quick Links
            </h3>
            ...
            <div className="flex flex-col space-y-4 mt-4">
              {quickLinks.map((link, index) => (
                <div key={index} className="h-6">
                  <div className="font-normal text-white text-xl leading-6 transition-all duration-200 hover:text-[#c1272d]">
                    <a onClick={() => handleNavigation(link.link)} className="cursor-pointer">{link.title}</a>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="mt-12 pt-6 border-t border-[#9370db] flex justify-center">
          <div className="font-normal text-white text-xl text-center leading-6">
