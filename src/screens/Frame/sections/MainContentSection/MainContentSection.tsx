...
export const MainContentSection = (): JSX.Element => {
  ...
  return (
    <section id="aboutUs" className="w-full bg-[#9370db1a] py-8 sm:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1280px]">
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 items-center">
          <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8">
            <h2 className="font-bold text-4xl sm:text-5xl text-[#483d8b] font-sans leading-tight sm:leading-10">
              About Sree Kamakshi Silks
            </h2>

            <div className="space-y-4 sm:space-y-6">
              <p className="text-base sm:text-lg text-[#333333] font-normal leading-relaxed sm:leading-7 font-sans">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                className="w-full sm:w-auto bg-[#483d8b] text-white hover:bg-[#483d8b]/90 text-base sm:text-lg font-sans"
                size="lg"
              >
                Our Services
              </Button>
              ...
              <Button
                variant="outline"
                className="w-full sm:w-auto border-2 border-[#483d8b] text-[#483d8b] hover:bg-[#483d8b]/10 text-base sm:text-lg font-sans"
                size="lg"
              >
                Contact Us
              </Button>
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="absolute -bottom-4 left-4 bg-[#c1272d] rounded-lg p-4 shadow-[0px_10px_15px_#0000001a,0px_4px_6px_#0000001a] text-white">
              <p className="font-bold text-base sm:text-lg font-sans">{`${getYearsDifference()}+ Years`}</p>
              <p className="text-base sm:text-lg font-sans">of Excellence</p>
            </div>
          </div>
        </div>
      </div>
